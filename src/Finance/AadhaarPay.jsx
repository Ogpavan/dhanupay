    ...
    return (
        <div className="min-h-screen font-poppins bg-white px-4 py-6">
            <div className="flex items-center mb-6 cursor-pointer" onClick={() => navigate(-1)}>
                ...
                <span className="text-sm font-medium text-gray-700">Aadhaar Pay</span>
            </div>

            <div className="">
        <h1 className="text-xl font-bold text-blue-700 text-center ">Aadhar Pay</h1>
        <h2 className="text-md text-gray-600 text-center mb-8">Send Money Using Aadhar with ease</h2>
      </div>
