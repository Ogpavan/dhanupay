            ...
            {showForm && (
                <div className="fixed inset-0 bg-white z-50 flex flex-col p-6 overflow-y-auto">
                    ...
                    <form onSubmit={handleFormSubmit} className="space-y-4">
                        ...
                        <div>
                            <label className="block font-medium text-gray-700">Type of Insurance</label>
                            <select
                                name="insuranceType"
                        ...
                        <div>
                            <label className="block font-medium text-gray-700">Pre-existing Conditions (Optional)</label>
                            <textarea
                                name="conditions"
