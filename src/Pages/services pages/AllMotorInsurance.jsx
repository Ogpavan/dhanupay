            ...
            {showForm && (
                <div className="fixed inset-0 bg-white z-50 flex flex-col p-6 overflow-y-auto">
                    ...
                    <form onSubmit={handleFormSubmit} className="space-y-4">
                        ...
                        <div>
                            <label className="block font-medium text-gray-700">Vehicle Number</label>
                            <input
                                type="text"
                                name="vehicleNumber"
                        ...
                        <div>
                            <label className="block font-medium text-gray-700">Insurance Type</label>
                            <select
                                name="insuranceType"
...
export default AllMotorInsurance