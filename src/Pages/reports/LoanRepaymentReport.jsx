...
function LoanRepaymentReport() {
  ...
  return (
    ...
    <div className='flex items-center bg-white shadow px-4 py-3'>
      ...
      <h1 className='text-xl font-semibold'>LoanRepayment Report</h1>
    </div>

    {/* Report Content */}
    <div className='text-center p-5'>
      <div className='text-2xl font-semibold mb-4'>LoanRepayment report</div>
