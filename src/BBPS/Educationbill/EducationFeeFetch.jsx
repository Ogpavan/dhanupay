...
const EducationFeeFetch = () => {
  ...
  useEffect(() => {
    if (!studentId || !stateName || !institute || !studentName) {
      navigate("/educationfee");
    }
  }, [studentId, stateName, institute, studentName, navigate]);
    ...
    <div className="font-poppins min-h-screen bg-white px-4 py-6 sm:hidden">
      ...
      <div className="flex flex-col items-center justify-center bg-white px-4 font-[Poppins] relative">
        <div className="text-center mb-16">
          <h2 className="text-lg text-blue-600 font-semibold">Confirm Fee Payment</h2>
        ...
        <div className="relative bg-gray-100 pt-10 p-6 rounded-2xl shadow-md w-full max-w-sm text-center">
          ...
          <h3 className="font-semibold text-gray-800 text-base mb-1 mt-2">{institute}</h3>
          <p className="text-gray-600 text-sm mb-2">{studentName}</p>
...
export default EducationFeeFetch;
