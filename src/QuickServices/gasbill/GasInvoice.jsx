  ...
  const handlePrint = () => {
    ...
    const htmlContent = `
      <html>
        ...
        <body>
          <div class="receipt">
            <div class="title">Gas Payment Receipt</div>
    ...
    <div className="font-poppins min-h-screen bg-green-500 px-4 py-6 sm:hidden">
      ...
      <div className="bg-green-100 p-6 rounded-2xl w-full max-w-sm mx-auto text-center">
        ...
        <div className="text-left text-sm text-green-800 space-y-2 mb-6">
          ...
          <div><span className="font-semibold">Provider:</span> {provider}</div>
          <div><span className="font-semibold">Phone No:</span> {phoneNumber}</div>
