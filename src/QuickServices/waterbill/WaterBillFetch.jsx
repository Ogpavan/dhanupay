      ...
      <div className="flex flex-col items-center justify-center bg-white px-4 font-[Poppins] relative">
        <div className="text-center mb-16">
          ...
          <p className="text-sm text-gray-600">
            Please confirm you want to <br /> proceed with the water bill payment
          </p>
        </div>
        ...
        <div className="relative bg-gray-100 pt-10 p-6 rounded-2xl shadow-md w-full max-w-sm text-center">
          ...
          <div className="absolute -top-10 left-1/2 transform -translate-x-1/2">
            <img
              src="https://media.9curry.com/uploads/organization/image/1964/delhi-jal-board-logo.png"
              alt="Water"
          ...
          <div className="text-3xl font-bold text-gray-800 mb-2">₹ 190.00</div>
        ...
        <button
          onClick={() =>
            navigate("/waterinvoice", {
              state: {
                provider,
                phoneNumber,
                name,
                billNumber: "WB-4569821",
